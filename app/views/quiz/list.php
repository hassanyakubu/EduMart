...
<div class="container" style="margin: 3rem auto;">
    ...
    <div style="background: #d1ecf1; border-left: 4px solid #17a2b8; padding: 1rem; margin-bottom: 2rem; border-radius: 4px;">
        ...
        <p style="margin: 0.5rem 0 0 0; color: #856404; background: #fff3cd; padding: 0.5rem; border-radius: 4px; font-size: 0.9rem;">
            <strong>Debug:</strong> No quizzes found. This could mean: (1) No published quizzes exist, (2) No quizzes in your purchased categories, or (3) Purchase not recorded in order_items table.
        </p>
        <?php endif; ?>
    </div>
    <?php endif; ?>
